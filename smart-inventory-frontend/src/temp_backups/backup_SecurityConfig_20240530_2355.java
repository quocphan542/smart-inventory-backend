...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // KÍCH HOẠT PHÂN QUYỀN Ở CẤP ĐỘ HÀM (@PreAuthorize)
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Cho phép tất cả mọi người truy cập các API này
                        .requestMatchers("/api/auth/**", "/api/debug/**", "/v3/api-docs/**", "/swagger-ui/**").permitAll()
                        // Đối với tất cả các request khác, chỉ cần xác thực là được
