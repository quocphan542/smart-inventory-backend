...
const OutboundPage = () => {
    ...
    if (loadingData) return <div className="inbound-chassis"><div className="console-title-stamp">{t('issue.loading') || 'ĐANG KHỞI TẠO TRẠM XUẤT KHO...'}</div></div>;
